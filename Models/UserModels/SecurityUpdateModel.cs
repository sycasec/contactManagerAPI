...
namespace contactManagerAPI.Models.UserModels
{
    ...
    public class SecurityUpdateModel
    {
        ...
        [StringLength(
            150,
            ErrorMessage = "Old Password must be between {2} and {1} characters long.",
            MinimumLength = 6
        )]
        ...
        [Compare(
            "ConfirmNewPassword",
            ErrorMessage = "Password does not match with Confirm New Password."
        )]
        [StringLength(
            150,
        ...
        [Compare(
            "NewPassword",
            ErrorMessage = "Confirm New Password does not match with New Password."
        )]
        [Required(ErrorMessage = "Confirm New Password field is required.")]
        [StringLength(
            150,
            ErrorMessage = "Confirm New Password must be between {2} and {1} characters long.",
            MinimumLength = 6
        )]
