...
namespace contactManagerAPI.Services.UserRepository
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<bool> UserExists(UserAuthDTO req) {
            ...
            var emailExists = await _context.Users.AnyAsync(u => u.EmailAddress == req.EmailAddress);
        ...
        public async Task<bool> UpdateUser(UserDTO req)
        {
            ...
            if(userExists){
                ...
                foreach (var prop in DTOprops){
                    if(typeof(User).GetProperty(prop.Name) != null && prop.GetValue(req) != null){
                        typeof(User).GetProperty(prop.Name)?
